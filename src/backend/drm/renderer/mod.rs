    ...
    B: Framebuffer,
{
    ...
    fn cleanup(&mut self) {
        self.fb_cache.retain(|key, _| key.upgrade().is_ok());
    }
}
    ...
    <I as ImportBuffer<B>>::Error: std::error::Error + Send + Sync,
{
        ...
        <R as Renderer>::TextureId: Texture + 'static,
    {
        ...
        for element in elements.iter() {
            ...
            // TODO: Track the opaque regions and filter out
            // completely obscured elements (applies to both,
            // elements on overlays/cursor and on the primary)

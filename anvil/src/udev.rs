...
fn render_surface<'a>(
    ...
    let space_elements = smithay::desktop::space::space_render_elements::<_, Window, _>([space], output)
    ...
    surface
        .renderer
        .render_output::<_, OutputRenderElements<_, _>, _>(renderer, &*elements, CLEAR_COLOR, logger.clone());
...
fn initial_render(
    ...
    surface.renderer.render_output::<_, CustomRenderElements<_>, _>(
        renderer,
        &[],
        CLEAR_COLOR,
        logger.clone(),

...
fn element_visible_size_ref(
    ...
    workhouse = Rectangle::subtract_rects_many_in_place_ref(workhouse, &**opaque_regions);
    workhouse
        .iter()
...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    c.bench_function("element_visible_size_ref", |b| {
        b.iter(|| {
            element_visible_size_ref(test_element, &opaque_regions);
        });
    });
